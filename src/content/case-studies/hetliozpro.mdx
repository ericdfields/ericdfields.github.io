...
figures:
  ...
  -
    ...
    -
      src: /assets/new-hetlioz-mobile.png
      srcType: image
      caption: Responsive design shows a tightened header, mobile-friendly typography, and sticky horizontal content navigation.
    -
