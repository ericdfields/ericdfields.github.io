...
figures:
  -
    -
      src: /assets/survey2-tool.mov
      srcType: video
      caption: Survey2 administrating. The video shows the panel editor and its multiple sub-features.
  -
    -
      src: /assets/crm-1.png
      srcType: image
      caption: CRM screenshot.
      alt: CRM screenshot.
    -
      src: /assets/crm-9.png
      srcType: image
      caption: CRM screenshot.
      alt: CRM screenshot.
---
